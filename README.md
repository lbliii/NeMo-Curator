...
In terms of scalability and compute performance, using the combination of RAPIDS and Dask fuzzy deduplication enabled us to deduplicate the 1.78 Trillion token Red Pajama dataset in 0.5 hours with 4 NVIDIA H100 GPUs.
