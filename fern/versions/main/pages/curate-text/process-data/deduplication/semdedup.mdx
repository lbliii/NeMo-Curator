...
| `cache_kwargs` | dict | `{}` | Additional reader and writer arguments, including storage options, for intermediate files and duplicate-ID artifacts, including those under `output_path`. |
| `write_kwargs` | dict | `{}` | Additional reader and writer arguments, including storage options, for final deduplicated output and reading duplicate-ID artifacts. |
