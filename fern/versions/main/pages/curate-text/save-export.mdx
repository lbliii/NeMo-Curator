...
commit_path = "./curated.lance-commit"

pipeline.add_stage(LanceWriter(path=dataset_path, commit_path=commit_path))
pipeline.run()

version = commit_lance_checkpoint(dataset_path, commit_path)
