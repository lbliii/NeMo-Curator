...
<Card title="Sound Event Detection" href="/curate-audio/process-data/sound-event-detection">
Run the maintained PANNs CNN14 pipeline on an audio manifest
sound-event-detection
framewise-probabilities
gpu
</Card>
